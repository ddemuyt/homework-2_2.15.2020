    ...
    <div>
      <Container style={{ marginTop: 30 }}>
        ...
        <Row>
          ...
          <div className="text-wrap col-sm-8">Hey, I'm Drake! I was born and raised in a small town in Indiana and went to the University of Saint Francis in Fort Wayne, IN. My degree is a Bachelor of Arts in Communication, but I am going back to school with George Washington University's Full-Stack Coding Bootcamp. After six months, I am knowledgable in HTML, CSS, JavaScript, MySQL, Progressive Working Applications, Agile Development, and MERN (MongoDB, Express, React,and Node.js). My goals are to work hard in this bootcamp, develop my skills to the utmost ability, and show future employers the expertise I've gained in such a short period of time.</div>
          </Col>
        </Row>
      </Container>
    </div>
